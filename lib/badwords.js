...
class Filter {
   ...
   * @param {boolean} options.lastLetter - Display last letter of word, depends on firstLetter being
  ...
  replaceWord(string) {
    ...
    if (this.firstLetter == true && this.lastLetter == false) {
      return firstLetter + rawString.substr(1,(string.length -1));
    } else if (this.firstLetter == true && this.lastLetter == true) {
      return firstLetter + rawString.substr(1,(string.length -2)) + lastLetter;
    } else {
      return rawString;
    }
  }
