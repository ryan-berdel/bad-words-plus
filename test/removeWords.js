...
describe('filter', () => {
  describe('removeWords',() => {
    it('Should allow you to remove words from the filter blocklist and no longer filter them (case-insensitive)', () => {
      filter.removeWords('Hells');
      assert(filter.clean('This is a hells good test') === 'This is a hells good test');
    });

    it ('Should allow you to remove an array of words from the filter blocklist and no longer filter them', () => {
